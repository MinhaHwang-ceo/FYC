		...
		<table align="center" style="width: 49%;">
			...
			<tr>
				...
				<td colspan="4" style="width:65%; border:1px solid lightgray;">
						...
						<div align="center" style="margin:0 auto; width:600px; height: 350px;">
							<img src="resources/uploadFiles/${b.newFileName}" width="600px" height="350px" />
						</div>
						</c:if>
						<c:if test="${b.newFileName == null}">
						<div align="center" style="margin:0 auto; width:600px; height: 350px;">
					...
					<div style="min-height: 500px;"><c:out value="${ b.bcontent }" escapeXml="false"/></div>
				</td>
			</tr>
	...
	<script>
		...
		function updateBoard(){
			if(confirm("글을 수정하시겠습니까?")){
				location.href="updateBoardFrm.bo?bNo="+bNo;
			...
			if(confirm("#삭제된 글은 노출되지 않지만 데이터베이스에 남아있습니다#\n정말로 글을 삭제하시겠습니까?")){
				$.ajax({
					...
					success:function(data) {
						console.log("삭제성공");
						//location.href="deleteBoardNotice.bo?bNo="+bNo;
					},
					error:function(err){
						console.log("삭제 실패");
					}
