			...
			<table align="center" style="width: 60%;">
				...
				<tr style="height: 100px;">
					...
					<td colspan="3" class="center">
						<button type="button" id="insertBoard" class="btn" style="width:100px;" name="insertBoard">등록</button>
						<button type="button" id="cancel" class="btn" style="width:100px;" name="cancel">취소</button>
					</td>
				</tr>
			</table>
		</form>
