	...
	<div id="outer" style="min-height: 1000px;">
		<form action="insertBoard.bo" method="post" id="insertBoardFrm"
			...
			<table align="center" style="width: 60%; text-align: center;">
				...
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="bTitle" style="width:100%;" id="bTitle"/></td>
				</tr>
				<tr>
					<th>작성자 :</th>
					<td><input type="text" name="writer" id="writer" class="readonly" readonly value="${sessionScope.loginUser.userId }"/></td>
				...
				<tr style="height: 100px;">
					<td></td>
					<td><button type="button" id="insertBoard" class="btn" style="width:100px;" name="insertBoard">등록</button></td>
					<td></td>
					<td><button type="button" id="cancel" class="btn" style="width:100px;" name="cancel">취소</button></td>
				</tr>
			</table>
		</form>
	</div>
