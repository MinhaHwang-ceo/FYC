	...
	<input type="hidden" id="userNo" value="${p.userNo}" name="userNo" />
		...
		<table>
			...
			<tr>
				<td>
					<div id="fileArea">
						<input type="file" id="photo" name="photo" onchange="loadImg(this, 1)" style="display: none;">
					</div>
					<br />
				</td>
			</tr>
			...
			<tr>
				...
				<td id="fno"><input type="date" min="2017-08-15" value="${p.endDate}" name="endDate">
				<script>
			...
			<tr>
				...
				<td id="fno" style="background:Lightgray;">
				<input type="radio" id="progressStatus" name="progressStatus" value="오픈예정" style="width:14px;height:14px;">
   				<label for="progressStatus"><span></span>오픈예정 ok</label><br>
   				<input type="radio" id="progressStatus" name="progressStatus" value="오픈" style="width:14px;height:14px;"> 
   				<label for="progressStatus"><span></span>오픈예정 no</label>
