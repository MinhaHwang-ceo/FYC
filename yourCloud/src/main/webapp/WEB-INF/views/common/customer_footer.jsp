    ...
    <section class="section-7">
        ...
        <footer class="page-footer font-small stylish-color-dark">
            ...
            <div class="container text-center text-md-left">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-sm-12 mx-auto box-1">
                        ...
                        <!-- Content -->
                        <a href="index.html"><img src="/yc/resources/images/yc-logo3.png" alt="footer-logo"></a>
                    ...
                    <div class="col-lg-2 col-sm-4 box-2 mx-auto">
                        ...
                        <!-- Links -->
                        <h5 align="center">니가 그린 구름 그림</h5>

                        <ul class="list-unstyled" align="center">
                            <li>
                                <a href="index.html">서무권</a> &nbsp;
                            
                                <a href="services.html">오수정</a>
                            </li>
                            <li>
                                <a href="portfolio.html">김진수</a> &nbsp;
                            
                                <a href="blog.html">복권석</a>
                            </li>
                            <li>
                                <a href="contact.html">고지효</a> &nbsp;
                             
                                <a href="contact.html">황민하</a>
                            </li>
                        </ul>
            ...
            <div class="footer-copyright text-center">
                ...
                <p>© 2019, All Rights reserved. more theme, designed by<a href="http://localhost:8001/yc/index.jsp"> 니가 그린 구름 그림</a></p>
            </div>
            <!-- Copyright -->
