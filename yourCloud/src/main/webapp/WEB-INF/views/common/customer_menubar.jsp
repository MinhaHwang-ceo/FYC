		...
		<nav class="navbar navbar-expand-sm ">
			<div class="right-box" id="navbar3">
				<ul class="navbar-nav">
					...
					<li><a class="nav-link" href="${ contextPath }/FundingOpen.me">펀딩 오픈하기</a></li>
				</ul>
				<ul class="navbar-nav">
					<li><i class="fa" aria-hidden="true"><img src="/yc/resources/images/hwack2.PNG"></i> <input type="text">
					</li>
				</ul>
				<ul>
					<li class=" webTest">
