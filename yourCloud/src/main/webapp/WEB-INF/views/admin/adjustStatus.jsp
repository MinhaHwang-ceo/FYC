...
<script>
      $(document).ready(function(){
         ...
         $("#btnUpdate").click(function(){
            ...
            if(confirm("수정하시겠습니까?")){
            	adjustStatus = $("#adjustStatus").val();
               location.href = "adjustUpdate.ad?projectNo="+projectNo+"&adjustStatus="+adjustStatus;
