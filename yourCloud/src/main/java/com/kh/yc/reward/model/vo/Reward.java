...
public class Reward {
	...
	public Reward(int rewardNo, int rewardMoney, String sortNo, String rewardName, String option,
			...
			int deliveryMoney, Date startDate, String options, String payStatus, String rewardCategory,
			String rewardDetail, int point, String memberPhone) {
		super();
	...
	public String toString() {
		return "Reward [rewardNo=" + rewardNo + ", rewardMoney=" + rewardMoney + ", sortNo=" + sortNo + ", rewardName="
				...
				+ ", startDate=" + startDate + ", options=" + options + ", payStatus=" + payStatus + ", rewardCategory="
				+ rewardCategory + ", rewardDetail=" + rewardDetail + ", point=" + point + ", memberPhone="
				+ memberPhone + "]";
	}
