...
public class NaverMember implements java.io.Serializable {
	...
	public NaverMember(int userNo, String userId, String userPwd, String email, String userName, String ssn,
			String companyName, String account, String gender, String memberCategory, int point, int age, String status,
			String memberDiv, String emailAgree, String profile) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public String toString() {
		return "NaverMember [userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", email=" + email
				...
				+ ", status=" + status + ", memberDiv=" + memberDiv + ", emailAgree=" + emailAgree + ", profile="
				+ profile + "]";
	}
